...
sampler = spotpy.algorithms.sceua(spotpy_hyd_mod, dbname='sceua_results_glob1WDt', dbformat='csv')

sampler.sample(repetitions=35000)

#results = sampler.getdata()                                                  # Load the results
results = spotpy.analyser.load_csv_results('sceua_results_glob1WDt')
...
save_path = f"results/groups/garonne_best_params_globcomptWD_Group_2.csv"
