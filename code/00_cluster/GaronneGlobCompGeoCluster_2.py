...
combined_df = pd.read_csv("data/network_estreams_garonne_22_gauges.csv")
...
for group in group_names:
    ...
    class spotpy_model(object):
        ...
        def objectivefunction(self, simulation, evaluation):
            ...
            for sim, cat in zip(simulation, self._catchments):
                ...
                obj_value = obj_fun_kge(observations=obs, simulation=sim)
    ...
    spotpy_hyd_mod = spotpy_model(
        ...
        parameter_names=[
            ...
            "high_slow_k", "general_slow_k", "low_slow_k", "unsaturated_Ce", "snow_k", "snow_t0", "unsaturated_Smax", "general_lowersplitter_splitpar", "high_lowersplitter_splitpar", "low_lowersplitter_splitpar",
    ...
    sampler = spotpy.algorithms.sceua(spotpy_hyd_mod, dbname='sceua_results_glob2t', dbformat='csv')

    sampler.sample(repetitions=75000)

    #results = sampler.getdata()                                                  # Load the results
    results = spotpy.analyser.load_csv_results('sceua_results_glob2t')
    ...
    save_path = f"results/groups/garonne_best_params_globcomptkge_{group}_2.csv"
