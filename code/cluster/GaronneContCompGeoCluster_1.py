...
for group in group_names:
    ...
    sampler = spotpy.algorithms.sceua(spotpy_hyd_mod, dbname='sceua_results_cont1t', dbformat='csv')

    sampler.sample(repetitions=75000)

    #results = sampler.getdata()
    results = spotpy.analyser.load_csv_results('sceua_results_cont1t')
    ...
    save_path = f"results/groups/garonne_best_params_contcompt_{group}.csv"
