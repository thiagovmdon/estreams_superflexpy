...
for group in group_names[2:3]:
    ...
    sampler = spotpy.algorithms.sceua(spotpy_hyd_mod, dbname='sceua_results_glob2', dbformat='csv')

    sampler.sample(repetitions=50000)

    #results = sampler.getdata()                                                  # Load the results
    results = spotpy.analyser.load_csv_results('sceua_results_glob2')
    ...
    save_path = f"results/groups/moselle_best_params_globcomp_{group}_2_2.csv"
