...
path_inputs = 'data/models/inputtavarela/subset_1988_2001'
...
combined_df = pd.read_csv("data/network_estreams_tavarela_42_gauges.csv")
...
for group in group_names:
    ...
    save_path = f"results/groups/tavarela_best_params_cont_{group}_2.csv"
