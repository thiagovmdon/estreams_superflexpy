...
path_inputs = 'data/models/inputadour/subset_1988_2001'
...
combined_df = pd.read_csv("data/network_estreams_adour_24_gauges.csv")
...
for group in group_names:
    ...
    save_path = f"results/groups/adour_best_params_glob_{group}_2.csv"
