...
for group in group_names:
    ...
    spotpy_hyd_mod = spotpy_model(
        ...
        parameter_names=[
            "general_fast_k", "general_slow_k", "unsaturated_Ce", "snow_k", "unsaturated_Smax", "general_lowersplitter_splitpar",
    ...
    save_path = f"results/groups/moselle_best_params_nogeo_{group}_2.csv"
