...
for cat_id in catchments_ids:
    ...
    unsaturated = CustomUnsaturatedReservoir(
        parameters={'Csmax': 1.5, 'Ce': 1.201276697682664, 'm': 0.01, 'beta': 0.697150813655771, 'bacon': rootdepth_mean[cat_id]},
        states={'S0': 10.0},
        approximation=num_app,
        id='unsaturated')
...
spotpy_hyd_mod = spotpy_model(
    ...
    parameter_names=[
        ...
        #"high_slowhigh_k", "general_slow_k", "unsaturated_Ce", 
        "unsaturated_Csmax", 
        #"general_lowersplitter_splitpar", "snow_k", 
...
save_path = f"results/groups/best_params_regi_Group_2RD.csv"
