...
path_inputs = 'data/models/inputseine/subset_1988_2001'
...
combined_df = pd.read_csv("data/network_estreams_seine_65_gauges.csv")
...
for group in group_names:
    ...
    save_path = f"results/groups/seine_best_params_glob_{group}_2.csv"
