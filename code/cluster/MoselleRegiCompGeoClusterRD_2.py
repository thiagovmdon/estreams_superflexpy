...
for group in group_names[0:1]:
    ...
    sampler = spotpy.algorithms.sceua(spotpy_hyd_mod, dbname='sceua_results_RD2', dbformat='csv')

    sampler.sample(repetitions=30000)

    #results = sampler.getdata()
    results = spotpy.analyser.load_csv_results('sceua_results_RD2')
    ...
    save_path = f"results/groups/moselle_best_params_regicompRD_{group}_2.csv"
